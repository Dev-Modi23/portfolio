...
I&apos;m a <b className="font-bold">student</b> passionate about{" "}
<b className="font-bold">Machine Learning and Data Science</b>. I enjoy{" "}
<i className="italic">building projects and exploring new technologies</i>. 
      </motion.h1>
